...
// coursVo의 setter/getter 사용
public class MysqlCoursDao implements CoursDao {
	...
	public List<CoursVo> list(int pageNo, int pageSize) 
			throws Throwable {
		Connection con = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			...
			ArrayList<CoursVo> list = new ArrayList<CoursVo>();
			
			while(rs.next()) {
				list.add(new CoursVo()
													.setNo(rs.getInt("CNO"))
	...
	public void update(CoursVo cours) throws Throwable {
		Connection con = null;
		PreparedStatement stmt = null;
		try {
			con = dbConnectionPool.getConnection();
